 ...
 * @date 2019/4/16.
 */
public class FBLoopViewPager extends RecyclerView {
    ...
    public FBLoopViewPager(Context context) {
        super(context);
    }

    public FBLoopViewPager(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FBLoopViewPager(Context context, @Nullable AttributeSet attrs, int defStyle) {
